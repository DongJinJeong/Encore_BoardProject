...
<html>
	...
	<body>
		...
		<div class="content">
			<form action="FindUserPasswordServlet" method=post >
			<br>
			<label for="loginId">ID</label>
			<input name="id" size=15 label=loginId placeholder="id"><br><br>
			<input type="submit" value="비밀번호 찾기" style="height:40px; width:240px;"><br>
			</form>
		</div>
	</body>
</html>